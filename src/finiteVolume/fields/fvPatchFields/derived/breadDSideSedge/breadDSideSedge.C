...
// template<class Type>
bool Foam::breadDSideSedgeFvPatchVectorField::readMixedEntries
(
...
// template<class Type>
Foam::breadDSideSedgeFvPatchVectorField::breadDSideSedgeFvPatchVectorField
(
    const fvPatch& p,
...
Foam::breadDSideSedgeFvPatchVectorField::breadDSideSedgeFvPatchVectorField
(
    const breadDSideSedgeFvPatchVectorField& ptf,
    const fvPatch& p,
    const DimensionedField<vector, volMesh>& iF,
...
// template<class Type>
void Foam::breadDSideSedgeFvPatchVectorField::autoMap
(
...
// template<class Type>
void Foam::breadDSideSedgeFvPatchVectorField::rmap
(
...
)
{
    ...
    const breadDSideSedgeFvPatchVectorField& mptf =
        refCast<const breadDSideSedgeFvPatchVectorField>(ptf);
...
// template<class Type>
void Foam::breadDSideSedgeFvPatchVectorField::evaluate(const Pstream::commsTypes)
{
    if (!this->updated())
    {
        this->updateCoeffs();
...
Foam::breadDSideSedgeFvPatchVectorField::snGrad() const
{
    return lerp
    (
        refGrad_,
...
// template<class Type>
Foam::tmp<Foam::vectorField>
Foam::breadDSideSedgeFvPatchVectorField::valueInternalCoeffs
(
...
// template<class Type>
Foam::tmp<Foam::vectorField>
Foam::breadDSideSedgeFvPatchVectorField::valueBoundaryCoeffs
(
    const tmp<scalarField>&
) const
{
...
// template<class Type>
Foam::tmp<Foam::vectorField>
Foam::breadDSideSedgeFvPatchVectorField::gradientInternalCoeffs() const
{
...
// template<class Type>
Foam::tmp<Foam::vectorField>
Foam::breadDSideSedgeFvPatchVectorField::gradientBoundaryCoeffs() const
{
    return lerp
    (
        refGrad_,
...
void Foam::breadDSideSedgeFvPatchVectorField::writeScalarEntry(Foam::Ostream& os, Foam::word name, Foam::scalar value) const
{
    os.write("\n\t\t");
    os.write(name);
    os.write("\t");
...
// template<class Type>
void Foam::breadDSideSedgeFvPatchVectorField::write(Ostream& os) const
{
