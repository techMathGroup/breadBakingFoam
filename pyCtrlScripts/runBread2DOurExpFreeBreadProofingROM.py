...
# Python script to set up and run bread baking simulations for baking curve optimizations
...
def runSim(outFolder, pars):
    # CASE FOLDERS==========================================================
    baseCaseDir = '../ZZ_cases/afterProofing/' # -- base case for simulation
