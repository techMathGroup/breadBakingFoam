...
experiments = [
    ...
    # },
    {
        ...
        'thermoOffset': np.array([0, 1.04, -0.06])*1e-2, 
        # 'thermoOffset': np.array([0, 0, 0])*1e-2, 
    },
    {
        'date': '10_02_2026',
        'expNumber': '3',
        'excelFileOven': 'opcua_log_20260210_153553.xlsx',
        'excelFileBread': 'Lab_test_2026_02_10.xlsm',
        'hLoaf': 4.46e-2,
        'rLoaf': 6.47e-2,
        'hLoafKynuti':4.8e-2,
        ...
        # 'thermoOffset': np.array([0, 1.18, -0.29])*1e-2, 
        'thermoOffset': np.array([0, 0.14, -1.24])*1e-2, 
    },
    {
        'date': '11_02_2026',
        'expNumber': '1',
        'excelFileOven': 'opcua_log_20260211_115313.xlsx',
        'excelFileBread': 'Lab_test_2026_02_11.xlsm',
        'hLoaf': 4.46e-2,
        'rLoaf': 6.47e-2,
        'hLoafKynuti':4.8e-2,
        # 'rLoafKynuti': 4.4e-2,
        ...
        # 'thermoOffset': np.array([0, -0.67, -0.03])*1e-2, 
        'thermoOffset': np.array([0, -0.14, 0.34])*1e-2, 
    },
    {
        'date': '11_02_2026',
        'expNumber': '2',
        'excelFileOven': 'opcua_log_20260211_125251.xlsx',
        'excelFileBread': 'Lab_test_2026_02_11.xlsm',
        'hLoaf': 4.46e-2,
        'rLoaf': 6.47e-2,
        'hLoafKynuti':4.8e-2,
        ...
        # 'thermoOffset': np.array([0, 0.2, 0.09])*1e-2, 
        'thermoOffset': np.array([0, -0.6, -0.11])*1e-2, 
    },
    {
        'date': '11_02_2026',
        'expNumber': '3',
        'excelFileOven': 'opcua_log_20260211_135519.xlsx',
        'excelFileBread': 'Lab_test_2026_02_11.xlsm',
        'hLoaf': 4.46e-2,
        'rLoaf': 6.47e-2,
        'hLoafKynuti':4.8e-2,
        ...
        # 'thermoOffset': np.array([0, 0.54, 0.31])*1e-2, 
        'thermoOffset': np.array([0, 0.51, 0.26])*1e-2, 
    },
    {
        'date': '11_02_2026',
        'expNumber': '4',
        'excelFileOven': 'opcua_log_20260211_150638.xlsx',
        'excelFileBread': 'Lab_test_2026_02_11.xlsm',
        'hLoaf': 4.46e-2,
        'rLoaf': 6.47e-2,
        'hLoafKynuti':4.8e-2,
        ...
        # 'thermoOffset': np.array([0, -0.02, 0.12])*1e-2, 
        'thermoOffset': np.array([0, -0.13, -0.15])*1e-2, 
    },
]
